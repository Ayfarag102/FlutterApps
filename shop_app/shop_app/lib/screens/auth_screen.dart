          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(26, 191, 62, 1).withOpacity(0.5),
...
class _AuthCardState extends State<AuthCard>
  ...
  Animation<Offset> _slideAnimation; // Height Animation
  ...
  void initState() {
    ...
    // _hAnimation.addListener(() => setState(() {}));
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: AnimatedContainer(
        ...
        curve: Curves.easeIn,
        //AnimatedBuilder(
        //  animation: _hAnimation,
        //  builder: (ctx, ch) =>
        //   Container(
        height: _authMode == AuthMode.Signup ? 320 : 260,
        //  height: _hAnimation.value.height,
        constraints:
            BoxConstraints(minHeight: _authMode == AuthMode.Signup ? 320 : 260),
        //   BoxConstraints(
        // minHeight: _hAnimation.value.height,
        //    ),
